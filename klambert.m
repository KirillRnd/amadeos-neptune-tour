function [V1, V2, extremal_distances, exitflag] = klambert(r1vec, r2vec, tf, m, muC, longway)
    ...
    extremal_distances = minmax_distances(r1vec*r1, r1, r2vec*r1, mr2vec*r1, dth, a*r1, V1, V2, m, muC);
...
function [V1, V2, extremal_distances, exitflag] = lambert_LancasterBlanchard(r1vec, r2vec, tf, m, muC)
%{
...
function extremal_distances = minmax_distances(r1vec, r1, r2vec, r2, dth, a, V1, V2, m, muC)
